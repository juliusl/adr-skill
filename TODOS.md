...
| 12 | TW create.md | Step 4 assessment written before 4a/4b can override — execution order unspecified | Low | Fix next branch | Agents write assessment after 4a/4b in practice. One sentence clarifying order removes ambiguity. |
| 13 | TW create.md | Step 4a Redesign verdict doesn't gate Step 4b — TPM may assess an already-escalated ADR | Low | Fix next branch | One conditional guard in Step 4b prevents redundant dispatch. |
