...
Self-contained reference for the ADR review workflow. Read this file when
the user asks to review, critique, validate, or give feedback on an ADR.

Use this reference as a prompt for a general-purpose agent to perform the
review. The review process is structured into six steps executed in order.
...
1. **Evidence** — Is there confidence the design will work? (PoC, spike, peer
   validation)
2. **Criteria** — Are ≥2 genuine alternatives identified and compared?
3. **Agreement** — Is there stakeholder consensus? Was involvement planned
   early?
4. **Documentation** — Is the decision captured in a template and shared?
5. **Realization/Review** — Is implementation scheduled? Is there a revisit
   date?
...
Also check for the **AI über-confidence** bonus fallacy: AI-generated
...
- **Dummy Alternative** — including obviously bad options to make the chosen
  one look good
...
**Magic tricks:**
- **Pseudo-accuracy** — false quantitative scoring to disguise subjective
  judgment
...
4. **Suggest revisions** — if the user indicates a consequence is inaccurate or
   ...
   certainty (e.g., "Expected to reduce deployment time" vs. "Reduces
