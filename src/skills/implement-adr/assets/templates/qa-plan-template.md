...
|---|-------|----------------|---------|----------------|--------|
| 1 | 1 | Quality concern | Description | Recommendation | ⚠️ Open / ✅ Resolved / Won't Fix |
| 2 | 1 | Preference | Description | Reason for deferral | — |
...
| **Recommendations** | Flat table of all findings with Classification column (quality concern / preference). Won't Fix rationale follows the table when applicable |
