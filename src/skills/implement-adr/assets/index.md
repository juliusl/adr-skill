# Asset Index — implement-adr

Curated index of assets available to the implement-adr skill.

## High-Value (Load First)
...
_No archive assets yet. As the skill matures, full originals of distilled
references will be stored in `assets/archive/`._
